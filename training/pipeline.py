...
from marl_6 import train_MAPPO, critic_model, leader_policy, follower_policy
import time
...
def main(algorithms: list[str] = None): # main pipeline goes here
    ...
    episodes_list = [2] # Now we only consider a static number of episodes for simplicity
    ...
    algorithms = ['MAPPO', 'DIAL'] if not algorithms else algorithms
    max_steps_list = [100]
    ...
    print(f"✅ Completed the training pipeline with {algorithms} successfully.")
