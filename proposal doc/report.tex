...
\begin{ganttchart}[
  ...
  \ganttgroup{Phase 1: Simulation \& PPO Training (Kelvin)}{1}{2} \\
  \ganttbar{Main Development (Kelvin)}{1}{2} \\
  \ganttbar[bar/.append style={fill=pink!70}]{Reporting and Documenting (Chintan)}{1}{3} \\
  \ganttbar[bar/.append style={fill=green!70}]{Preparation for Phase 2 (Kimia)}{1}{2} \\

  % Phase 2: MADQN/MAPPO Training
  \ganttgroup{Phase 2: MADQN/MAPPO Training \& Integration (Kimia)}{3}{4} \\
  \ganttbar{Main Development (Kimia)}{3}{4} \\
  \ganttbar[bar/.append style={fill=pink!70}]{Reporting and Documenting (Kelvin)}{3}{5} \\
  \ganttbar[bar/.append style={fill=yellow!70}]{Integration Testing for Outcomes from Phase 1 (Kelvin)}{3}{5} \\
  \ganttbar[bar/.append style={fill=green!70}]{Preparation for Phase 3 (Chintan)}{3}{4} \\

  % Phase 3: Evaluation and Optimization
  \ganttgroup{Phase 3: Evaluation \& Optimization (Chintan)}{5}{6} \\
  \ganttbar{Main Development (Chintan)}{5}{6} \\
  \ganttbar[bar/.append style={fill=pink!70}]{Reporting and Documenting (Kimia)}{4}{6} \\
  \ganttbar[bar/.append style={fill=yellow!70}]{Integration Testing for Outcomes from Phase 2 (Kimia)}{4}{6} \\
  \ganttbar[bar/.append style={fill=yellow!70}]{Integration Testing for Outcomes from Phase 3 (Kelvin)}{6}{6} \\
  \ganttbar[bar/.append style={fill=orange!70}]{Iteratively Testing Final Outcomes (Everyone)}{5}{6} 
