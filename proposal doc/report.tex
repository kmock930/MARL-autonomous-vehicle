...
]{1}{6} % Timeline from Week 1 to Week 6

% Titles
\gantttitle{Project Timeline (Weeks)}{6} \\
\gantttitle{1}{1} \gantttitle{2}{1} \gantttitle{3}{1} \gantttitle{4}{1} \gantttitle{5}{1} \gantttitle{6}{1} \\

% Phases with names
\ganttbar[name=phase1]{\textbf{Phase 1: Simulation \& PPO Training (Kelvin)}}{1}{2} \\
\ganttbar[name=phase2]{\textbf{Phase 2: Train MADQN/MAPPO \& Comm (Kimia)}}{3}{4} \\
\ganttbar[name=phase3]{\textbf{Phase 3: Evaluation \& Optimization (Chintan)}}{5}{6}
