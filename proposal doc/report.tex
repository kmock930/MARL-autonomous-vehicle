...
\begin{ganttchart}[
  ...
  \ganttbar[bar/.append style={fill=yellow!70}]{Integration Testing for Outcomes from Phase 1 (Kelvin)}{4}{5} \\
  ...
  \ganttbar[bar/.append style={fill=yellow!70}]{Integration Testing for Outcomes from Phase 2 (Kimia)}{5}{6} \\
  \ganttbar[bar/.append style={fill=orange!70}]{Iteratively Testing Final Outcomes (Everyone)}{6}{6} 
